...
public class Person {
    ...
    private int money;
    //String[] Product_bag;
    //private ArrayList<String> Product_bag = new ArrayList<>();
    ...
    public void Person(String pName, int pMoney) {
        ...
        // ArrayList<String> Product_bag = new ArrayList<>();
        //list.add("Элемент 1");

        //в комментариях преподаватель писал, что можно сделатьмассив на 10 единиц, этого хватит
